<?php
    require_once("../site/bat/twitter_api/twitteroauth/twitteroauth.php"); // Path to twitteroauth library
    require_once('../site/bat/twitter_api/config.php'); // Path to config file
